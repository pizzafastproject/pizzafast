...
(6, 'Барбекю', 490, 'сливочный соус, сыр моцарелла, грибы шампиньоны, лук красный, бекон, курица, помидоры, соус барбекю, укроп, пармезан', 'barbq.jpg'),
(7, 'Карбонара', 490, 'бекон, сыр моцарелла, томатный соус, красный лук, специи (черный молотый перец)', 'Karbonara.jpg'),
(8, 'Маргарита', 450, 'соус Нео (томаты консервированные, лук репчатый, специи, масло оливковое, масло растительное, базилик свежий), сыр моцарелла, томаты', 'marg.gpg'),
