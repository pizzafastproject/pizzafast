...
(5, 'Ассорти', 550, 'колбаса салями, помидоры, болгарский перец, сыр моцарелла, куриное филе, маслины', 'assorti.jpg'),
(6, 'Барбекю', 490, 'сливочный соус, сыр моцарелла, грибы шампиньоны, лук красный, бекон, курица, помидоры, соус барбекю, укроп, пармезан', 'bbq.jpg'),
(7, 'Карбонара', 490, 'бекон, сыр моцарелла, томатный соус, красный лук, специи (черный молотый перец)', 'Karbonara.jpg'),
(8, 'Маргарита', 390, 'соус Нео, сыр моцарелла, томаты', 'marg.jpg'),
(9, 'Вегетарианская', 450, 'соус Нео, брокколи, шампиньоны, маслины, моцарелла', 'veg.jpg'),
(10, 'Мясная', 490, 'соус Нео, маринованная свинина, бекон, красный лук, шампиньоны, сыр Моцарелла, укроп', 'meat.jpg'),
...
(20, 'Грибная', 390, 'моцарелла, шампиньоны, базилик, сливочный соус, томатный соус', 'mashrooms.jpg'),
(21, 'Мега', 550, 'моцарелла, голландский сыр, пармезан, бекон, ветчина, шампиньоны, салями, томаты, куриное филе, кукуруза, сливочный соус, томатный соус', 'mega.jpg'),
(22, 'Деревенская', 450, 'моцарелла, томаты, помидоры черри, кукуруза, лук, шампиньоны, томатный соус', 'derev.jpg'),
(23, 'Домашняя', 450, 'моцарелла, шампиньоны, сосиски, лук, перец красный, соус томатный', 'home.jpg'),
(24, 'Лисья', 450, 'грибы лисички, моцарелла, томаты, лук, оливки, куриное филе, томатный соус', 'fox.jpg'),
(25, 'Трюфельная', 550, 'моцарелла, слайсы чёрного трюфеля, шампиньоны, лук, соус сальса, соус сливочный', 'trufel.jpg');
(26, 'Цезарь', 490, 'куриное филе, моцарелла, томаты, листья салата, соус цезарь, сливочный соус', 'cezar.jpg'),
(27, 'Чили', 490, 'перец чили, картофель, томаты, перец зелёный, лук, соус томатный, соус чили, моцарелла', 'hot.jpg'),
(28, 'Блиц', 490, 'моцарелла, томаты, оливки, перец зелёный, ананас, томатный соус', 'bliz.jpg');
COMMIT;
-- --------------------------------------------------------
